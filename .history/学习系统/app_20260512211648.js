      ...
      <div class="quiz-result">
        ...
        <div class="actions">
          ...
          ` : `
            ...
            <button class="btn btn-primary" onclick="startDrill(drillState.moduleId)">再刷一组</button>
          `}
        </div>
      </div>
    </div>`;
