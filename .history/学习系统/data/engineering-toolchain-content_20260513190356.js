  ...
  docs: [
    makeLongformDoc({
      ...
      flow: [
        ...
        '提交 lockfile，并在 CI 使用 npm ci、pnpm --frozen-lockfile 或等价 frozen install。',
...
\`\`\``,
      ...
      references: ['npm package.json 官方文档', 'pnpm Workspaces 与 frozen-lockfile 文档', 'Node.js Corepack 文档', 'SemVer 官方规范'],
      quiz: [
