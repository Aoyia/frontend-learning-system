    ...
    <div className="article-wrap">
      ...
      {doc.links && doc.links.length > 0 && (
        <div className="official-links">
          <div className="official-links-title">📚 官方文档参考</div>
          <div className="official-links-list">
            {doc.links.map(link => (
              ...
              >
                <span className="official-link-name">{link.title}</span>
                {link.desc && <span className="official-link-desc">{link.desc}</span>}
              </a>
            ))}
          </div>
        </div>
