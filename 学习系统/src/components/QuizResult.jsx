...
export default function QuizResult({
  ...
  const currentModule = LEARNING_CONTENT.modules.find(x => x.id === quizState.moduleId);
  const moduleDocLen = quizState.type === 'doc' && currentModule ? currentModule.docs.length : 0;
