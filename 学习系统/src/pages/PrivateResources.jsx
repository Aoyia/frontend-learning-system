...
import '@arco-design/web-react/es/Modal/style/index.css';
...
export function PrivateResources({ isOpen, onClose, onSaveSuccess }) {
  ...
  useEffect(() => {
    if (isOpen) {
      ...
      setRepo(localStorage.getItem('github_repo') || 'Aoyia/my-private-interview-docs');
